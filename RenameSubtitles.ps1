...
Write-Output "Subtitles have been successfully renamed!" # Выводим сообщение об удачном выполнении скрипта в конце, когда все неприятные ситуации уже учтены.
